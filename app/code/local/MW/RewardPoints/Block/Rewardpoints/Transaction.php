...
class MW_RewardPoints_Block_Rewardpoints_Transaction extends Mage_Core_Block_Template
{
	...
	public function getTransactionNew(){
	
		if (Mage::getSingleton('customer/session')->isLoggedIn()){
				
			$collection=Mage::getModel("rewardpoints/cashout")->getCollection()->addFieldToFilter("customer_id",array("eq"=>Mage::getSingleton("customer/session")->getCustomer()->getId()));	
			return $collection;
