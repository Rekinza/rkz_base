...
class MW_RewardPoints_Block_Adminhtml_Cartrules_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      ...
      $this->setEmptyText(Mage::helper('rewardpoints')->__('No Shopping Cart Earning Rule Found'));
  }

  protected function _prepareCollection()
  {
      $collection = Mage::getModel('rewardpoints/cartrules')->getCollection();
