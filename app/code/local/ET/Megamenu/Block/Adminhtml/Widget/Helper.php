...
class ET_Megamenu_Block_Adminhtml_Widget_Helper extends Mage_Widget_Block_Adminhtml_Widget_Options {

	protected $_debug = 0;
	
	public function init($fieldset, $form) {
		$this->_translationHelper = Mage::helper('megamenu');
