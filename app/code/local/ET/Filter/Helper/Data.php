...
class ET_Filter_Helper_Data extends Mage_Core_Helper_Data{

    const MULTIPLE_FILTERS_DELIMITER = ',';

    public function isEnabled() {
        return Mage::getStoreConfigFlag('et_filter_configs/catalog/enabled');
    }
    ...
    public function isAjaxEnabled() {
        ...
        return Mage::getStoreConfigFlag('et_filter_configs/catalog/use_ajax');
    }
    ...
    public function isMultipleChoiceFiltersEnabled(){
        ...
        return Mage::getStoreConfigFlag('et_filter_configs/catalog/multiple_filters');
    }
    ...
    public function isPriceSliderEnabled(){
        ...
        return Mage::getStoreConfigFlag('et_filter_configs/catalog/price_slider');
    }

    public function getPriceSliderDelay(){
        return Mage::getStoreConfig('et_filter_configs/catalog/price_slider_delay');
    }

    public function getPriceSliderSubmitType() {
        return (int) Mage::getStoreConfig('et_filter_configs/catalog/price_slider_submit_type');
    }

    public function getRoutingSuffix() {
        return '/' . Mage::getStoreConfig('et_filter_configs/catalog/routing_suffix');
    }
