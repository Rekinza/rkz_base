...
class ET_Slider_Block_Adminhtml_Caption_Grid extends Mage_Adminhtml_Block_Widget_Grid {
	public function __construct() {
		parent::__construct();
		$this->setId('caption_grid');
	...
	protected function _prepareCollection() {
		$collection = Mage::getModel('slider/caption')->getCollection();
	...
	protected function _prepareMassaction() {
		...
		$this->getMassactionBlock()->setFormFieldName('caption_param');
